Attribute VB_Name = "modSSPLogon"
'' In a Login Form use the following behind the OK command button
''
''Private Sub cmdOK_Click()
''    ' Check to see if a password is entered
''    If Trim(txtPassword.Text) = "" Then
''        MsgBox "You must enter a password to access this application!", vbInformation + vbOKOnly, "Password Required"
''    Else
''        sUsername = Trim(txtUsername.Text)
''        sPassword = Trim(txtPassword.Text)
''        sDomain = Trim(cboDomain.Text)
''
''        Call SSPValidateUser(sUsername, sDomain, sPassword)
''
''        If bSSPValidateUser = True Then
''            Me.Hide
''            Unload frmMain
''            frmMain.Show
''        Else
''            MsgBox "The Password entered is incorrect! Please retype the Password making sure it is in lowercase", vbInformation + vbOKOnly, "Invalid Password"
''        End If
''    End If
''End Sub
...
Global bSSPValidateUser As Boolean
